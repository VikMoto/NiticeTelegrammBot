package com.javacore10.featur.telegram.command;
...
public class StartCommand extends BotCommand {
    ...
    public void execute(AbsSender absSender, User user, Chat chat, String[] arguments) {
       String text = "Hello! I`am bot for notifications.\n " +
               "Press on \"Create notification\" for start working";
        SendMessage sendMessage = new SendMessage();
        sendMessage.setText(text);
        sendMessage.setChatId(Long.toString(chat.getId()));

        final KeyboardButton create_notificationButton = KeyboardButton
                .builder()
                .text("Create notification")
                .build();
        KeyboardRow keyboardRow = new KeyboardRow();
        keyboardRow.add(create_notificationButton);
